var click = document.getElementById('lvd');
click.onclick = function () {
    var mykeyword = document.getElementById('search');
    var YOUTUBE_API = "https://content.googleapis.com/youtube/v3/search?q=" + mykeyword.value + "&type=video&maxResults=9&part=snippet&key=AIzaSyAwUjk3CwtXCiB_W6Xi0colfOKPgm90hHc";
